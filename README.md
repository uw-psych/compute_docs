...
If you'd like to develop and/or build this book, you should:
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/uw-psych/compute_docs/graphs/contributors).
