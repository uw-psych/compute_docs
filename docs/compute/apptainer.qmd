...
From: python:{{ PY_VERSION }} # Which container to use as a base image. # <2>

%arguments # <3>
    # The version of Python to use:
    PY_VERSION=3.10-slim
